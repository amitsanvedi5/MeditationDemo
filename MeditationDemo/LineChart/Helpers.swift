...
public struct GradientColor {
    ...
    public init(start: Color, middle: Color, end: Color) {
        self.start = start
        self.middle = middle
        self.end = end
    }
    ...
    public func getGradient() -> Gradient {
        return Gradient(colors: [start, middle, middle, end])
    }
}
...
public class ChartStyle {
    ...
    public init(backgroundColor: Color, accentColor: Color, secondGradientColor: Color, textColor: Color, legendTextColor: Color, dropShadowColor: Color){
        ...
        self.gradientColor = GradientColor(start: accentColor, middle: secondGradientColor, end: accentColor)
        self.textColor = textColor
        self.legendTextColor = legendTextColor
        self.dropShadowColor = dropShadowColor
    }
    
    public init(backgroundColor: Color, accentColor: Color, lineColor: Color, textColor: Color, legendTextColor: Color, dropShadowColor: Color){
        self.backgroundColor = backgroundColor
        self.accentColor = accentColor
        self.gradientColor = GradientColor(start: .white, middle: lineColor, end: .white)
        self.textColor = textColor
        self.legendTextColor = legendTextColor
        self.dropShadowColor = dropShadowColor
    }
    ...
    public init(formSize: CGSize){
        ...
        self.gradientColor = GradientColor(start: Colors.OrangeStart, middle: Colors.OrangeStart, end: Colors.OrangeStart)
...
public class MultiLineChartData: ChartData {
    ...
    public init<N: BinaryFloatingPoint>(points:[N], color: Color) {
        self.gradient = GradientColor(start: color, middle: color, end: color)
        super.init(points: points)
    }
